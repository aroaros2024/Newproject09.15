 ...
 */
const h = (id, name, effect, price, weight, desc) => ({
    id, kind: 'herb', name, desc, price, weight, sprite: 'herb', effect, throwPower: 3,
});
const sc = (id, name, effect, price, weight, desc) => ({
    id, kind: 'scroll', name, desc, price, weight, sprite: 'scroll', effect, throwPower: 3,
});
const st = (id, name, effect, price, weight, ballistics, desc, charges = [3, 6]) => ({
...
export const SCROLLS = [
    ...
    sc('escapeScroll', '脱出の巻物', 'escapeDungeon', 2500, 20, '読むと ダンジョンから 脱出して 村へ 戻る。持ち物は そのまま持ち帰れる。'),
    sc('releaseScroll', '解除の巻物', 'releaseStatus', 700, 28, 'かなしばり・まひ・封印など、体にかかった異常を すべて 解く。'),
