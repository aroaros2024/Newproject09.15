 ...
 */
const pot = (id, name, effect, capacity, price, weight, desc) => ({
    id, kind: 'pot', name, desc, price, weight, sprite: 'pot',
    capacity, effect, throwPower: 4,
});
const br = (id, name, effect, price, weight, desc) => ({
    id, kind: 'bracelet', name, desc, price, weight, sprite: 'bracelet',
    effect, throwPower: 3,
});
const food = (id, name, nutrition, price, weight, desc, maxUp = 0, effect) => ({
...
export const ALWAYS_CURSED_BRACELETS = [
