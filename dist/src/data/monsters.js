...
const RAW = [
    ...
    // ===================================================== ボス
    m('bossForest', '森の主 オオヤマネコ', 'boss', 0, 6, 150, 18, 10, 2000, 'せせらぎの森の奥に棲む大山猫。素早い爪さばきで襲いかかる。', { ai: 'boss', speed: 'double', boss: true, skills: ['doubleAttack', 'leapAttack'],
        rate: 40, sprite: 'bossForest' }),
    m('bossVolcano', '火口の番人 イワオニ', 'boss', 1, 9, 210, 54, 11, 6000, '灼熱の火山の火口を守る岩の鬼。溶岩を投げつけてくる。', { ai: 'boss', move: 'lava', boss: true, skills: ['breatheFire', 'throwBoulder', 'summonAlly'],
        rate: 45, sprite: 'bossVolcano' }),
    m('bossWaterway', '水路の淀み ヌシ', 'boss', 2, 12, 260, 48, 12, 14000, '常闇の地下水路に沈む巨大な影。水と闇を操る。', { ai: 'boss', move: 'water', boss: true, speed: 'double',
        skills: ['waterJet', 'blindTouch', 'summonAlly'], rate: 50, sprite: 'bossWaterway' }),
    m('bossTowerFirst', '天輪の守り手', 'boss', 3, 15, 230, 74, 13, 30000, '天輪の塔の頂で待つ者。まだ本気ではない。', { ai: 'boss', boss: true, speed: 'double',
        skills: ['doubleAttack', 'magicBind', 'summonAlly'], rate: 50, sprite: 'bossTower' }),
    m('bossTowerFinal', '天輪の主 カゼノヌシ', 'boss', 4, 20, 260, 86, 14, 80000, '風そのものが形をとった姿。すべての風来人の行き着く先。', { ai: 'boss', boss: true, speed: 'double',
        skills: ['breatheInferno', 'levelDrain', 'magicBind', 'summonAlly', 'healSelf'],
        rate: 60, sprite: 'bossTowerFinal' }),
    m('bossAbyss', 'もっと不思議の果て', 'boss', 5, 25, 350, 190, 17, 200000, '99 階の最奥に在るもの。名前を持たない。', { ai: 'boss', boss: true, speed: 'double',
