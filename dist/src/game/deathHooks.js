...
export function recordBossDefeat(world, m) {
    ...
    for (const other of [...world.run.monsters]) {
        if (other === m || world.defOf(other).isBoss)
            continue;
...
//# sourceMappingURL=deathHooks.js.map