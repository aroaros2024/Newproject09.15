...
/** 一周の正弦（0〜1 の位相） */
export const wave = (phase) => Math.sin(phase * Math.PI * 2);
...
export function idleBreath(frames = 4, fps = 4, amp = 1) {
    return {
...
export function walkCycle(frames = 8, fps = 10) {
    return {
        frames, fps, loop: true,
        pose(i, n, out) {
            const t = i / n;
...
export function hop(frames = 4, fps = 10, height = 3) {
    return {
        frames, fps, loop: true,
        pose(i, n, out) {
            const t = i / n;
...
export function flap(frames = 4, fps = 10, bobAmp = 2) {
    return {
        frames, fps, loop: true,
        pose(i, n, out) {
            const t = i / n;
 ...
 */
export function attackSwing(frames = 6, fps = 15, strike = 2) {
    return {
...
export function lunge(frames = 5, fps = 15, strike = 2, reach = 4) {
    return {
        frames, fps, loop: false, strike,
        pose(i, n, out) {
            const t = i / Math.max(1, n - 1);
...
export function castRaise(frames = 6, fps = 12, strike = 4) {
    return {
        frames, fps, loop: false, strike,
        pose(i, n, out) {
            const t = i / Math.max(1, n - 1);
...
/** 被弾：のけぞって目を閉じる */
export function hurt(frames = 2, fps = 12) {
    return {
...
export function sleep(frames = 2, fps = 2) {
    return {
        frames, fps, loop: true,
        pose(i, _n, out) {
            out.eyes = 2;
...
/** 道具を使う（主人公）：前へ掲げる */
export function useItem(frames = 4, fps = 12) {
    return {
