...
export class DepthOfField {
    d1 = new Surface(ART_W / 2, ART_H / 2, true, true);
    d2 = new Surface(ART_W / 4, ART_H / 4, true, true);
    out = new Surface(ART_W / 2, ART_H / 2, false, true);
    band = new Surface(2, ART_H, false, true);
    constructor() {
        ...
        for (let y = 0; y < ART_H; y++) {
            ...
            let a = 0;
            if (yc < top)
                a = TOP_STRENGTH * Math.pow(1 - yc / top, 1.6);
            else if (yc > ART_H - bottom)
                a = BOTTOM_STRENGTH * Math.pow((yc - (ART_H - bottom)) / bottom, 1.6);
    ...
    apply(g) {
        ...
        g.drawImage(o.c, 0, o.h - bottomRows, o.w, bottomRows, -CROP_X, -CROP_Y + (o.h - bottomRows) * k, ART_W * ART_SCALE, bottomRows * k);
    }
