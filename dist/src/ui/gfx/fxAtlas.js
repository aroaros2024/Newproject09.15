...
import { ARROW_SIZE, BLAST_FRAMES, BLAST_SIZE, ORB_SIZE, ORN_SIZE, SPARK_FRAMES, SPARK_SIZE, buildArrow, buildExplosion, buildHitSpark, buildOrb, buildOrnament, ornamentOf, } from '../art/fxSprites.js';
...
export function itemCanvas(key) {
    return baked(`i:${key}`, () => {
...
/** ワナの絵（16×16） */
export function trapCanvas(trapId) {
...
export function ornamentCanvas(id, frame) {
...
/** 矢（16×16、8 方向） */
export function arrowCanvas(dir8, tip = 'steel') {
    const d = dir8 & 7;
...
/** 魔法の玉（12×12、4 コマ） */
export function orbCanvas(frame, ramp) {
    const f = frame & 3;
...
/** 当たりの火花（16×16、4 コマ） */
export function sparkCanvas(frame) {
...
/** 爆発（32×32、6 コマ） */
export function blastCanvas(frame) {
...
//# sourceMappingURL=fxAtlas.js.map