...
import type { ItemDef, ItemKind } from '../../core/types.js';
...
export const UNIDENTIFIED_KINDS: readonly ItemKind[] = [
 ...
 */
export const KNOWABLE_ITEMS: readonly ItemDef[] = ALL_ITEMS.filter(
  (d) => UNIDENTIFIED_KINDS.includes(d.kind) && !d.alwaysIdentified && d.weight > 0,
);
