...
class Game implements App {
  ...
  readonly compositor = new Compositor(2);
  ...
  private onResize = (): void => {
    ...
    this.compositor.resize(this.canvas, window.innerWidth, window.innerHeight,
      window.devicePixelRatio || 1, this.settings.pixelPerfect);
